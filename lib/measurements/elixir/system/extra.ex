defmodule Measurements.System.Extra do
  @moduledoc """
      This module holds Extra functionality that is needed by Measurements.System,
    but not present, or not exposed in Elixir.System
  """

  @behaviour Measurements.System.ExtraBehaviour
  ...
  """
  @impl Measurements.System.ExtraBehaviour
